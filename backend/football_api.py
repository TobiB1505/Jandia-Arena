...
CACHE_TTL_FIXTURES = 180        # 3 min – fixtures during normal mode
CACHE_TTL_FIXTURES_LIVE = 20    # 20 s – tighter window while a match is live
CACHE_TTL_STANDINGS = 300       # 5 min – standings change slowly
